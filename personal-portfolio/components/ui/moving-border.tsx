...
export function Button({
  ...
  return (
    <Component
      className={cn(
        "bg-transparent relative text-xl rounded-full p-[6px] overflow-hidden ",
        containerClassName
      )}
      style={{
    ...
    >
      <div
        ...
        style={{ borderRadius: `calc(${borderRadius} * 1)` }}
      >
        <MovingBorder duration={duration} rx="50%" ry="50%">
          <div
            className={cn(
              "h-20 w-20 opacity-[0.9] blur-lg bg-[radial-gradient(var(--green-500)_100%,transparent_0%)]",
              borderClassName
            )}
          />
        </MovingBorder>
