...
export default function Navbar({ navigatePage, navs }: { navigatePage: (page: string) => void, navs: Navs }) {
    return (
        <nav className="w-full flex justify-between pl-12 pr-12 items-center shadow-soft-bottom shadow-white/30">
            <h1 className="text-4xl font-mntsrt"><span className="text-white/30">&lt;</span> Anubhaw<span className="text-light-green font-bold">Raman&nbsp;</span><span className="text-white/30">/&gt;</span></h1>
            <ul className="w-1/3 h-16 my-3 text-lg flex items-center justify-end gap-x-12 px-0 bg-black z-10">
